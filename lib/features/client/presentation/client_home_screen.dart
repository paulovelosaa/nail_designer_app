...
class ClientHomeScreen extends StatelessWidget {
  ...
  Future<String> _getFirstName() async {
    ...
    if (user != null) {
      ...
      final fullName = doc.data()?['nome'] ?? 'Cliente';
      ...
      appBar: AppBar(
        ...
        title: FutureBuilder<String>(
          ...
          builder: (context, snapshot) {
            final name = snapshot.data ?? 'Cliente';
            return Text(
              'Bem-vinda, $name ❤️',
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: const [
            ...
            SizedBox(height: 24),
            Expanded(child: _ClientMenuGrid()),
          ],
        ),
      ),
    );
...
class _ClientMenuGrid extends StatelessWidget {
  const _ClientMenuGrid();
